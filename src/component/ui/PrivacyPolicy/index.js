        ...
        <div className="container">
          <div className="row">
            <div className="col-md-10">
              ...
              <p className="Para-Terms">Last updated: January 01, 2024</p>
              ...
              <h2 className="Terms-twoHeading">
                Interpretation and Definitions
              </h2>
              <h3 className="Privacy-three">Interpretation</h3>
              <p className="Para-Terms">
              ...
              <h3 className="Privacy-three">Definitions</h3>
              <p className="Para-Terms">
              ...
              <ul>
                ...
                <li>
                  <p className="Para-Terms">
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to BOOKVENUE.
                  </p>
                </li>
                <li>
                  <p className="Para-Terms">
                ...
                <li>
                  <p className="Para-Terms">
                    <strong>Website</strong> refers to BOOKVENUE, accessible
                    from{" "}
                    <a
                      href="https://bookvenue.app"
              ...
              <h3 className="Privacy-three">Types of Data Collected</h3>
              <h4 className="Privacy-Four">Personal Data</h4>
              <p className="Para-Terms">
              ...
              <ul>
                <li>
                  <p className="Para-Terms">Email address</p>
                </li>
                <li>
                  <p className="Para-Terms">First name and last name</p>
                </li>
                <li>
                  <p className="Para-Terms">Phone number</p>
                </li>
                <li>
                  <p className="Para-Terms">
                ...
                <li>
                  <p className="Para-Terms">Usage Data</p>
                </li>
              </ul>
              <h4 className="Privacy-Four">Usage Data</h4>
              <p className="Para-Terms">
              ...
              <ul>
                <li>
                  ...
                  <p className="Para-Terms">Type: Session Cookies</p>
                  <p className="Para-Terms">Administered by: Us</p>
                  <p className="Para-Terms">
                ...
                <li>
                  ...
                  <p className="Para-Terms">Type: Persistent Cookies</p>
                  <p className="Para-Terms">Administered by: Us</p>
                  <p className="Para-Terms">
              ...
              <h3 className="Privacy-three">Use of Your Personal Data</h3>
              <p className="Para-Terms">
              ...
              <h3 className="Privacy-three">Retention of Your Personal Data</h3>
              <p className="Para-Terms">
              ...
              <h3 className="Privacy-three">Transfer of Your Personal Data</h3>
              <p className="Para-Terms">
              ...
              <h3 className="Privacy-three">Delete Your Personal Data</h3>
              <p className="Para-Terms">
              ...
              <h3 className="Privacy-three">
                Disclosure of Your Personal Data
              </h3>
              <h4 className="Privacy-Four">Business Transactions</h4>
              <p className="Para-Terms">
              ...
              <h4 className="Privacy-Four">Law enforcement</h4>
              <p className="Para-Terms">
              ...
              <h4 className="Privacy-Four">Other legal requirements</h4>
              <p className="Para-Terms">
                The Company may disclose Your Personal Data in the good faith
                belief that such action is necessary to:
              </p>
              <ul>
                <li className="list-Terms">Comply with a legal obligation</li>
                <li className="list-Terms">
                ...
                <li className="list-Terms">Protect against legal liability</li>
              </ul>
              <h3 className="Privacy-three">Security of Your Personal Data</h3>
              <p className="Para-Terms">
              ...
              <h2 className="Terms-twoHeading">Children's Privacy</h2>
              <p className="Para-Terms">
              ...
              <h2 className="Terms-twoHeading">Links to Other Websites</h2>
              <p className="Para-Terms">
              ...
              <h2 className="Terms-twoHeading">Contact Us</h2>
              <p className="Para-Terms">
              ...
              <ul>
                <li>
                  <p className="Para-Terms">
                    By email: mailto:info@bookvenue.app
                  </p>
                </li>
                <li>
                  <p className="Para-Terms">
                    ...
                    <a
                      href="https://bookvenue.app/contact-us"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://bookvenue.app/contact-us
                    </a>
                  </p>
                </li>
              </ul>
