...
function ReturnRefund() {
  return (
    <Default>
      <section className="Return-Refund">
        <div className="container">
          <div className="row">
            <div className="col-md-10">
              <h1 className="Terms-Heading">Return and Refund Policy</h1>
              <p className="Para-Terms">Last updated: January 01, 2024</p>
              <p className="Para-Terms">
                Thank you for shopping at bookvenue.app.
              </p>
              <p className="Para-Terms">
              ...
              <h2 className="Terms-twoHeading">Interpretation & Definitions</h2>
              ...
              <ul>
                <li>
                  <p className="Para-Terms">
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to bookvenue.app.
                  </p>
                </li>
                <li>
                  <p className="Para-Terms">
                ...
                <li>
                  <p className="Para-Terms">
                    <strong>Website</strong> refers to bookvenue.app, accessible
                    from{" "}
                    <a
              ...
              <ul>
                <li>
                  <p className="Para-Terms">
                    By email: mailto:info@giksindia.com
                  </p>
                </li>
                <li>
                  <p className="Para-Terms">
              ...
              <h2 className="Terms-twoHeading">Conditions for Returns</h2>
              <p className="Para-Terms">
              ...
              <h2 className="Terms-twoHeading">Returning Goods</h2>
              <p className="Para-Terms">
              ...
              <h2 className="Terms-twoHeading">Gifts</h2>
              <p className="Para-Terms">
              ...
              <h3 className="Privacy-three">Contact Us</h3>
              <p className="Para-Terms">
